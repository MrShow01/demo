  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Scaffold(
        ...
        appBar: _appBar(),
        body: (_addTransactionController.loadingStart.value)
            ? Center(
                child: Container(
                  color: Colors.white,
                  height: 250,
                  ...
                  child: LiquidLinearProgressIndicator(
                    value: _addTransactionController.loadingPresentage.value /
                        100, // Defaults to 0.5.
                    valueColor: AlwaysStoppedAnimation(Colors
                        .black26), // Defaults to the current Theme's accentColor.
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InputField(
                      hint:
                          _addTransactionController.selectedCategory.isNotEmpty
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            await DatabaseProvider.insertListTransaction(transactionList);
            Get.back(); */

            _addTransaction();
            /*  _addTransactionController.loadingStart(true);

            for (double i = 0.0; i <= 100.0;) {
              await Future.delayed(Duration(milliseconds: 50)).whenComplete(() {
                _addTransactionController.loadingPresentage(i);
                log(_addTransactionController.loadingPresentage.value
                    .toString());
                i++;
              });
            } */
