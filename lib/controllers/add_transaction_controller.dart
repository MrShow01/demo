...
class AddTransactionController extends GetxController {
  final Rx<String> transactionType = 'Income'.obs;
  ...
  final Rx<double> loadingPresentage = 0.0.obs;
  final Rx<bool> loadingStart = false.obs;
  ...
  //String get transactionType => transactionType.value;

  changeTransactionType(String tt) => transactionType.value = tt;
